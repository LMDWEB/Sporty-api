 ...
 */
final class Version20190630191521 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, home_team_id INT DEFAULT NULL, away_team_id INT DEFAULT NULL, league_id INT DEFAULT NULL, status VARCHAR(50) NOT NULL, score VARCHAR(30) DEFAULT NULL, goals_home_team INT DEFAULT NULL, goals_away_team INT DEFAULT NULL, event_start INT DEFAULT NULL, event_begin VARCHAR(255) DEFAULT NULL, round INT DEFAULT NULL, INDEX IDX_232B318C9C4C13F6 (home_team_id), INDEX IDX_232B318C45185D02 (away_team_id), INDEX IDX_232B318C58AFC4DE (league_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(25) NOT NULL, password VARCHAR(500) NOT NULL, is_active TINYINT(1) NOT NULL, nb_requests INT NOT NULL, nb_request_max INT NOT NULL, email VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_1483A5E9F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE game_suggest (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, author_id INT DEFAULT NULL, score_home_team INT DEFAULT NULL, score_away_team INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, is_valid INT DEFAULT NULL, INDEX IDX_1E4404A9E48FD905 (game_id), INDEX IDX_1E4404A9F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE game_suggest ADD CONSTRAINT FK_1E4404A9E48FD905 FOREIGN KEY (game_id) REFERENCES game (id)');
        $this->addSql('ALTER TABLE game_suggest ADD CONSTRAINT FK_1E4404A9F675F31B FOREIGN KEY (author_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game_suggest DROP FOREIGN KEY FK_1E4404A9E48FD905');
        $this->addSql('ALTER TABLE role_user DROP FOREIGN KEY FK_332CA4DDA76ED395');
        $this->addSql('ALTER TABLE comment DROP FOREIGN KEY FK_9474526C61220EA6');
        $this->addSql('ALTER TABLE game_suggest DROP FOREIGN KEY FK_1E4404A9F675F31B');
        ...
        $this->addSql('DROP TABLE game_suggest');
